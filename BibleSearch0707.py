...
book_files = {"創世記": "創世記.txt"}  # ここに他の巻のファイルも追加可能
book_files = {"出エジプト記": "出エジプト記.txt"}  # ここに他の巻のファイルも追加可能
book_files = {"レビ記": "レビ記.txt"}  # ここに他の巻のファイルも追加可能
book_files = {"民数記": "民数記.txt"}  # ここに他の巻のファイルも追加可能
book_files = {"申命記": "申命記.txt"}  # ここに他の巻のファイルも追加可能
